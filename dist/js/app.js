(() => {
  ...
  const de = document.getElementById("video-container"),
    ce = document.getElementById("play-button"),
    pe = de.querySelector(".video__frame"),
    ue = document.getElementById("video-cover");
